...
This repository contains structured **IT training materials** including **How-Tos**, **Cheat Sheets**, and **Projects** used for educational and demonstration purposes.  
...
| Folder | Description |
|--------|--------------|
| [`/How-Tos`](./How-Tos) | Step-by-step technical guides, template-ready readme's, and walkthroughs. |
| [`/CheatSheets`](./CheatSheets) | Quick command and reference sheets. |
| [`/Projects`](./Projects) | Full completed projects that reference how-to area. |
| [`/Assets`](./Assets) | Ignore this, this contains random testing files |
...
[![License](https://img.shields.io/badge/License-Educational_Use_Only-red?style=for-the-badge)]()
